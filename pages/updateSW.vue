      ...
      <b-row>
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400">
            <div>please use button below to fetch <span class="text-danger">latest version </span>
        ...
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400" class="mt-3">
            <div>please use button below to <span class="text-danger">remove </span>
        ...
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400" class="mt-3">
            <div>please use button below to <span class="text-danger">change</span> Food Composition Table</div>
            <b-button to="selectFct" class="my-2" variant="info" size="sm">select FCT</b-button>
          </b-card>
        </b-col>
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400" class="mt-3">
            <div>please use button below to <span class="text-danger">import</span> new Food Composition Table</div>
            <b-button to="importFCT" class="my-2" variant="info" size="sm">import FCT</b-button>
          </b-card>
        </b-col>
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400" class="mt-3">
            <div>please use button below to <span class="text-danger">edit</span> current Food Composition Table</div>
            <b-button to="editFct" class="my-2" variant="info" size="sm">edit FCT</b-button>
          </b-card>
        </b-col>
        <b-col cols="6" md="4" class="px-1">
          <b-card bg-variant="gray-400" class="mt-3">
            <div>please use button below to <span class="text-danger">change workspace</span></div>
