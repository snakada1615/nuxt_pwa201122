<template>
  <section class="container" style="max-width: 540px;">
    <div>
      <b-carousel
        id="carousel-fade"
      ...
      >
        <b-carousel-slide
          caption=""
          img-src="/img/NFA_intro01.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          caption=""
          img-src="/img/NFA_intro02.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          caption=""
          img-src="/img/NFA_intro03.jpg"
        ></b-carousel-slide>
        <b-carousel-slide
          caption=""
          img-src="/img/NFA_intro04.jpg"
        ></b-carousel-slide>
      </b-carousel>
    </div>
      ...
      <b-col cols="6" md="4" class="px-1">
        <b-card class="bg-info my-2">
            <b-card-body class="px-0 py-0">
              ...
              <b-button :disabled="!loginStatus" class="btn btn-warning m-auto btn-block" to="/dietCalk" Nuxt>go</b-button>
            </b-card-body>
        </b-card>
      </b-col>
      <b-col cols="6" md="4" class="px-1">
        <b-card class="bg-info my-2">
            <b-card-body class="px-0 py-0">
              ...
              <b-button :disabled="!loginStatus" class="btn btn-warning m-auto btn-block" to="/feasibilityCheck" Nuxt>go</b-button>
            </b-card-body>
        </b-card>
      </b-col>
      <b-col cols="6" md="4" class="px-1">
